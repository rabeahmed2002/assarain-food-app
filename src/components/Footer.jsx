      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-start">
        ...
        <div className="w-full md:w-1/2 mb-6 md:mb-0">
          ...
          <p className="text-sm text-gray-300 mt-4">
            Copyright © 2023 - Assarain Food Products L.L.C. Design & Developed by
            Codeswave
          </p>
        </div>
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-full md:w-2/3 px-4 py-2 text-black rounded outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button className="bg-blue-500 text-white px-4 py-2 font-semibold rounded hover:bg-blue-600">
              SIGN ME UP!
            </button>
          </div>
