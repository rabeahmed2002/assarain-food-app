      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-12 text-center">
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Global Brands</h4>
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Warehouses</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
              We use a hub and spoke distribution platform covering Oman with our Head Office and main stores located in Muscat.
            </p>
          </div>
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Pallet Capacity</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
              We use a hub and spoke distribution platform covering Oman with our Head Office and main stores located in Muscat.
            </p>
          </div>
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Own Vehicles</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
              We use a hub and spoke distribution platform covering Oman with our Head Office and main stores located in Muscat.
            </p>
          </div>
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Skilled Employees</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
              We use a hub and spoke distribution platform covering Oman with our Head Office and main stores located in Muscat.
            </p>
          </div>
          ...
          <div>
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-1">Channel Coverage</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
              We use a hub and spoke distribution platform covering Oman with our Head Office and main stores located in Muscat.
            </p>
          </div>
